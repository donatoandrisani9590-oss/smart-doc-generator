...
NOTIFICATION_TYPES = {
    ...
    "clause_approval_pending": {
        "label": "Klausel-Freigabe ausstehend",
        "description": "Benachrichtigung wenn eine Klausel zur Freigabe eingereicht wurde (für Admins)",
        "default_enabled": True,
    },
    "clause_approved": {
        "label": "Klausel freigegeben",
        "description": "Benachrichtigung wenn Ihre Klausel freigegeben wurde",
        "default_enabled": True,
    },
    "clause_rejected": {
        "label": "Klausel abgelehnt",
        "description": "Benachrichtigung wenn Ihre Klausel abgelehnt wurde",
        "default_enabled": True,
    },
}
...
async def notify_admins_clause_pending(
    ...
    for admin in admins:
        await create_notification(
            ...
            title="Neue Klausel zur Freigabe",
...
async def notify_clause_decision(
    ...
    if approved:
        await create_notification(
            ...
            title="Klausel freigegeben",
            message=f'Ihre Klausel "{clause_title}" wurde freigegeben und ist jetzt in der Bibliothek verfügbar.',
            priority="normal",
            entity_type="clause",
            entity_id=clause_id,
        ...
        await create_notification(
            ...
            title="Klausel abgelehnt",
            message=f'Ihre Klausel "{clause_title}" wurde abgelehnt. Grund: {reason or "Kein Grund angegeben"}',
            priority="normal",
            entity_type="clause",
            entity_id=clause_id,
            action_url="/admin/clauses",
