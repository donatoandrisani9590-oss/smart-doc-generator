...
KUENDIGUNG_CLAUSES = [
    {
        ...
        "content_html": '<p>[anrede_brief] <strong>[vorname] [nachname]</strong>,</p><p>hiermit k&uuml;ndigen wir das zwischen Ihnen und unserem Unternehmen bestehende Arbeitsverh&auml;ltnis ordentlich und fristgerecht zum n&auml;chstm&ouml;glichen Termin.</p>',
        "category": "Arbeitsrecht", "tags": ["kündigung", "kündigungserklärung"], "tone": "neutral",
        "is_mandatory": True, "display_order": 1,
    },
    {
        "title": "Kündigungsfrist und letzter Arbeitstag",
        "content_html": '<p>Unter Einhaltung der vertraglichen bzw. gesetzlichen K&uuml;ndigungsfrist gem&auml;&szlig; &sect; 622 BGB endet Ihr Arbeitsverh&auml;ltnis mit Ablauf des in der K&uuml;ndigung genannten Termins. Ihr Arbeitsverh&auml;ltnis besteht seit dem <strong>[eintrittsdatum]</strong>.</p>',
        "category": "Arbeitsrecht", "tags": ["kündigungsfrist", "letzter arbeitstag"], "tone": "neutral",
        "is_mandatory": True, "display_order": 2,
    },
    {
        "title": "Freistellung",
        "content_html": '<p>Wir stellen Sie ab sofort unwiderruflich von der Erbringung Ihrer Arbeitsleistung frei. Die Freistellung erfolgt unter Fortzahlung der vereinbarten Verg&uuml;tung und unter Anrechnung etwaiger Resturlaubs- und &Uuml;berstundenanspr&uuml;che.</p>',
...
ABMAHNUNG_CLAUSES = [
    {
        ...
        "content_html": '<p>[anrede_brief] <strong>[vorname] [nachname]</strong>,</p><p>wir m&uuml;ssen Sie hiermit wegen eines Versto&szlig;es gegen Ihre arbeitsvertraglichen Pflichten abmahnen.</p><p>Am <strong>[vorfall_datum]</strong> haben Sie folgende Pflichtverletzung begangen: Sie sind Ihrem Arbeitsplatz unentschuldigt ferngeblieben, ohne Ihren Vorgesetzten rechtzeitig zu informieren oder eine Arbeitsunf&auml;higkeitsbescheinigung vorzulegen.</p>',
...
ARBEITSZEUGNIS_CLAUSES = [
    ...
    },
    {
        ...
        "content_html": '<p>Das Verhalten von [anrede_dativ] <strong>[nachname]</strong> gegen&uuml;ber Vorgesetzten, Kolleginnen und Kollegen sowie externen Partnern und Kunden war jederzeit vorbildlich. Durch die freundliche, aufgeschlossene und kooperative Art wurde [anrede] [nachname] von allen sehr gesch&auml;tzt.</p>',
    ...
    },
    {
        ...
        "content_html": '<p>[anrede] <strong>[vorname] [nachname]</strong> verl&auml;sst unser Unternehmen auf eigenen Wunsch. Wir bedauern diese Entscheidung sehr und danken f&uuml;r die stets hervorragende und engagierte Zusammenarbeit.</p><p>F&uuml;r den weiteren beruflichen und pers&ouml;nlichen Lebensweg w&uuml;nschen wir [anrede_dativ] [nachname] alles Gute und weiterhin viel Erfolg.</p>',
    ...
    },
    {
        ...
        "content_html": '<p>&nbsp;</p><p>Sulzberg, den ________________</p><p>&nbsp;</p><p>&nbsp;</p><p>____________________________________</p><p>Gesch&auml;ftsf&uuml;hrung</p>',
